...
{
	options = {
		firefox_module.enable = lib.mkEnableOption "Enable Firefox module";
	};

	config = lib.mkIf config.firefox_module.enable {
		...
		programs = {
			...
			package = pkgs.wrapFirefox pkgs.firefox-unwrapped {
				...
				ExtensionSettings = {
					...
					# Writing
					"scholarcy.com" = {
					install_url = "https://addons.mozilla.org/firefox/downloads/latest/scholarcy-browser-extension/latest.xpi";
					installation_mode = "force_installed";
					};
			...
			profiles ={
				...
				search = {
					...
					"DeepL Translate" = {
						urls = [{ template = "https://www.deepl.com/translator#en/de/{searchTerms}"; }];
						icon = "https://static.deepl.com/img/_optimized/footer/deeplLogo.svg";
						definedAliases = [ "@l" ];
					};
					"Deepl Write" = {
						urls = [{ template = "https://www.deepl.com/write#en/de/{searchTerms}"; }];
						icon = "https://static.deepl.com/img/_optimized/footer/deeplLogo.svg";
						definedAliases = [ "@lw" ];
					};
					"Searx" = {
